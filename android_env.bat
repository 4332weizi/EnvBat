...
echo 增加PATH：;%%AndroidSDK_Dir%%\tools;%%AndroidSDK_Dir%%\platform-tools  
wmic ENVIRONMENT where  "name='path' and username='<system>'" set VariableValue="%PATH%;%%AndroidSDK_Dir%%\tools;%%AndroidSDK_Dir%%\platform-tools"     
